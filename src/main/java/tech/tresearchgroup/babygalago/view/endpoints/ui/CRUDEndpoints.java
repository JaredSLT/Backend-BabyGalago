...
public class CRUDEndpoints extends AbstractModule implements EndpointsRouter {
    private CRUDEndpointsController CRUDEndpointsController;

    public CRUDEndpoints() {
    }

    public CRUDEndpoints(tech.tresearchgroup.babygalago.controller.endpoints.ui.CRUDEndpointsController CRUDEndpointsController) {
        this.CRUDEndpointsController = CRUDEndpointsController;
    }
