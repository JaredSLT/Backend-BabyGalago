...
public class PlayEndpoints extends AbstractModule implements EndpointsRouter {
    private PlayEndpointsController playEndpointsController;

    public PlayEndpoints() {
    }

    public PlayEndpoints(PlayEndpointsController playEndpointsController) {
        this.playEndpointsController = playEndpointsController;
    }
